...
export default function UserProfile() {
    ...
    console.log(data);
    return (
        <div className="userProfileButton mr-[10px] flex grow justify-end">
            ...
            {
                showUserInformation ?
                <div className="profileInformation absolute flex flex-col justify-center items-center ml-[50px] z-[2] top-[62px] right-[10px] rounded-[8px] shadow-[2px_10px_28px_-16px]"
                id="profileInformation">
                    <div className="username text-[18px] font-[500] mt-[3px] mx-[10px]" id="username">{data.response.data.user_name}</div>
                    <div className="emailId text-[15px] mx-[10px]" id="emailId">{data.response.data.email}</div>
